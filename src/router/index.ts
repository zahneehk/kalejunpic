...
const routes: Array<RouteRecordRaw> = [
  ...
  },
  {
    ...
    name: "upload",
    component: upload,
    meta: { title: "nav.upload" }
  },
  {
    path: "/management",
    name: "Management",
    component: management,
    meta: { title: "nav.management" }
  },
  {
    path: "/settings",
    name: "settings",
  ...
  },
  {
    ...
    name: "Toolbox",
    component: toolbox,
    meta: { title: "nav.toolbox" },
    children: [
      { path: "/toolbox/compress", name: "Compress", component: compressTool },
      { path: "/toolbox/base64", name: "Base64", component: base64Tool },
      { path: "/toolbox/watermark", name: "Watermark", component: watermarkTool }
    ]
  },
  {
    path: "/:catchAll(.*)",
